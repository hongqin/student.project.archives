...
# if csv does NOT have "Notes"
tb = read.csv(infile, colClasses=c("character",NA, NA, "character", rep("numeric",7 ), NA));
names(tb) = c("Strain", "OD600", "Dilution","Date","H2O2stock", "White", "Black", "halfBlack", "quarterBlack", "ThreeQBlack", "QQBlack", "Other")
...
####### find out means
H2O2 = sort( unique( tb$H2O2)) #fixing the bug!!! 2012 Jan 25
#s = H2O2
...
mylabel = 'M13star Dec22011'

pdf("M13star.1222011.black.pdf", width=5, height=5)
...
pdf("M13star.1222011.Black-log.pdf", width=5, height=5)
tbf$H2O2[tbf$H2O2==0] = min(H2O2[-1])/10;
