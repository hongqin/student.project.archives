...
tb = read.csv("d.csv");
tb = read.csv("d.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M1-2star.04222011.black.pdf", width=5, height=5)
...
pdf("M1-2star.04222011.black-log.pdf", width=5, height=5)
