...
tb = read.csv("e.csv");
tb = read.csv("e.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("YPS128star.04292011.black.pdf", width=5, height=5)
...
title("YPS128 Met15+/- Apr 29, 2011")
dev.off()
...
pdf("YPS128star.04292011.black-log.pdf", width=5, height=5)
...
title("YPS128star.04292011.black")
dev.off()
