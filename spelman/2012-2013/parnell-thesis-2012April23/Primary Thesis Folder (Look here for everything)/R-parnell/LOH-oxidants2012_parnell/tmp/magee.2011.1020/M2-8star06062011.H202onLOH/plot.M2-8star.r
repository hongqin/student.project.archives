...
tb = read.csv("k.csv");
tb = read.csv("k.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M2-8star.06062011.black.pdf", width=5, height=5)
...
pdf("M2-8star.06062011.black-log.pdf", width=5, height=5)
