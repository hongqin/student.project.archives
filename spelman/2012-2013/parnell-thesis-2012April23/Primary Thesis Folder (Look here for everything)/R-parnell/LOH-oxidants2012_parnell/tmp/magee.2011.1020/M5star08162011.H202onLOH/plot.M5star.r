...
tb = read.csv("m.csv");
tb = read.csv("m.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M5star.08162011.black.pdf", width=5, height=5)
...
pdf("M5star.08162011.black-log.pdf", width=5, height=5)
