...
tb = read.csv("o.csv");
tb = read.csv("o.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M8star.02082011.black.pdf", width=5, height=5)
...
pdf("M8star.02082011.black-log.pdf", width=5, height=5)
