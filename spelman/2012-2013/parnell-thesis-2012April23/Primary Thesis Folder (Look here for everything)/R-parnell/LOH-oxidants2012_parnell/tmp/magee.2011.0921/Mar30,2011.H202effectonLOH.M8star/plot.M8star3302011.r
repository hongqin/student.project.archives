...
tb = read.csv("p.csv");
tb = read.csv("p.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M8Sstar.03302011.black.pdf", width=5, height=5)
...
pdf("M8star.033002011.black-log.pdf", width=5, height=5)
