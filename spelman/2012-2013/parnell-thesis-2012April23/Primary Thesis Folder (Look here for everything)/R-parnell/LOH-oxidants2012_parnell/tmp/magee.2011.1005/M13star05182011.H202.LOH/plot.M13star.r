...
tb = read.csv("f.csv");
tb = read.csv("f.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M13star.05182011.black.pdf", width=5, height=5)
...
pdf("M13star.05182011.black-log.pdf", width=5, height=5)
