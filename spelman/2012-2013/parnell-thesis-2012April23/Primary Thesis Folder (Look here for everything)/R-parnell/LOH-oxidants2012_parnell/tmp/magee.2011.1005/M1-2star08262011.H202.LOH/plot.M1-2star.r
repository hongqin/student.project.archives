...
tb = read.csv("h.csv");
tb = read.csv("h.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M1-2star.08262011.black.pdf", width=5, height=5)
...
title("M1-2 Met15+/- Aug 26, 2011")
dev.off()

tbf$Black[1] = 0.001  #This is a temporary fix. It has to be changed for other data. 

pdf("M1-2star.08262011.black-log.pdf, width=5, height=5)
