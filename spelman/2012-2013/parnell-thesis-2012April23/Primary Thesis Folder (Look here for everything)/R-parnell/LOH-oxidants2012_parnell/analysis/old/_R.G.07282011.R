# July 28, 2011 Does Tg/Tc support robustness hypothesis? 
...
######### R0 G
summary( lm( tb$G ~ tb$Tg.vs.Tc + tb$R0 ) ) #p=0.011, 
summary( lm( tb$R0~ tb$Tg.vs.Tc  ) ) #p=0.19
plot( tb$G ~ tb$Tg.vs.Tc)
plot( tb$R0 ~ tb$Tg.vs.Tc)

summary( lm( tb$G ~ tb$Tg + tb$R0 ) ) #
summary( lm( tb$G ~ tb$Tc + tb$R0 ) ) #
summary( lm( tb$G ~ tb$CLS + tb$R0 ) ) #
summary( lm( tb$G ~ tb$b.max + tb$R0 ) ) #
summary( lm( tb$G ~ tb$Pbt0 + tb$R0 ) ) #
summary( lm( tb$G ~ tb$L0.all + tb$R0 ) ) #
