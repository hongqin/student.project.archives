...
#-20.3023  -2.7075  -0.1261   3.2688  14.5121 

#Coefficients:
# Estimate Std. Error t value Pr(>|t|)    
#(Intercept)       24.2530     0.3224  75.219   <2e-16 ***
# RLS.tb2$myStddev   0.5380     0.6386   0.842      0.4    
#---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 5.114 on 495 degrees of freedom
#Multiple R-squared: 0.001432,  Adjusted R-squared: -0.0005854 
#F-statistic: 0.7098 on 1 and 495 DF,  p-value: 0.3999 
...
#Residuals:
# Min       1Q   Median       3Q      Max 
#-0.89252  0.00531  0.03462  0.05016  0.13237 

#Coefficients:
#(Intercept)      0.960758   0.002866 335.215  < 2e-16 ***
# fitness.tb2$myCV 0.279233   0.042430   6.581 6.02e-11 ***
#  ---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 0.09855 on 1913 degrees of freedom
#(507 observations deleted due to missingness)
#Multiple R-squared: 0.02214,  Adjusted R-squared: 0.02163 
#F-statistic: 43.31 on 1 and 1913 DF,  p-value: 6.016e-11 
