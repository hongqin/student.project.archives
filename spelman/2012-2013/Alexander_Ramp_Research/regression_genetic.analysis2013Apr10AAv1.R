...
lifespan$ORF = as.character( lifespan$ORF )

#Read growth fitness table into R
fit = read.csv("growth.fitness.hom.2012Nov13.csv");
...
save.image("../output/AA2013Apr10-V1.RData")
load("../output/AA2013Apr10-V1.RData")
...
abline( lm(lifespan$RLS_Del_alpha ~ lifespan$YPE), col="red");


###EVOLUTIONARY DISTANCE VS LIFESPAN REGRESSION ANALYSIS
#Match lifespan to evolutionary distance
lifespan$Ka = Kdata$Ka[match(lifespan$ORF,Kdata$orfname)];
...
#Sce.Smik = read.csv("Sce.Smik.csv", colClasses=c("character", "number","number","number" ));
Sce.Smik$orfname = as.character( Sce.Smik$orfname)
#lifespan$Ka = Sce.Smik$Ka[match(lifespan$ORF,data$orfname)]; #THIS is a bug!!!!
lifespan$Ka = Sce.Smik$Ka[match(lifespan$ORF,Sce.Smik$orfname)]; 
...
lifespan$Ka = Sce.Sbay$Ka[match(lifespan$ORF,Kdata$orfname)];
m = lm(lifespan$RLS_Del_alpha ~ lifespan$Ka);
summary(m);
...
#Perform linear regression of lifespan vs               and summarize results
summary( lm(lifespan$RLS_Del_alpha ~ lifespan$YPE))
summary( lm(lifespan$RLS_Del_alpha ~ lifespan$pDegree))
summary( lm(lifespan$RLS_Del_alpha ~ lifespan$gDegree))
...
#Plot regression analysis
plot(lifespan$RLS_Del_alpha ~ lifespan$YPE, ylab="Replicative Lifespan", xlab="Fitness (YPE)")
abline(lm(lifespan$RLS_Del_alpha ~ lifespan$YPE), col="red")

plot(lifespan$RLS_Del_alpha ~ lifespan$gDegree, ylab="Replicative Lifespan", xlab="Genetic Interactions" );
abline(lm(lifespan$RLS_Del_alpha ~ lifespan$gDegree), col="red");

plot(lifespan$RLS_Del_alpha ~ lifespan$pDegree, ylab="Replicative Lifespan", xlab="Protein Interactions" );
abline(lm(lifespan$RLS_Del_alpha ~ lifespan$pDegree), col="red");
...
save.image("AA2013Apr11.RData")
load("AA2013Apr11.RData")
...
plot(lifespan$RLS_Del_alpha ~ lifespan$scmdstddev, ylab = "Replicative Lifespan", xlab = "Morphological Plasticity")
abline(lm(lifespan$RLS_Del_alpha ~lifespan$scmdstddev), col="red")
...
#m = lm(lifespan$RLS_Del_alpha ~ lifespan$YPE + lifespan$Ka + lifespan$pDegree + lifespan$stddev );
#ERROR!!!! variable lifespan$stddev does not exist... should it be lifespan$scmdstddev??
m = lm(lifespan$RLS_Del_alpha ~ lifespan$YPE + lifespan$Ka + lifespan$pDegree + lifespan$scmdstddev );
summary(m);

#m = lm(lifespan$RLS_Del_alpha ~ lifespan$YPE + lifespan$Ka + lifespan$gDegree + lifespan$stddev );
m = lm(lifespan$RLS_Del_alpha ~ lifespan$YPE + lifespan$Ka + lifespan$gDegree + lifespan$scmdstddev );
summary(m);
...
m = lm(lifespan$YPE ~ lifespan$Ka + lifespan$pDegree + lifespan$scmdstddev);
summary(m);

#m = lm(lifespan$YPE ~ lifespan$Ka + lifespan$gDegree + lifespan$stddev); 
m = lm(lifespan$YPE ~ lifespan$Ka + lifespan$gDegree + lifespan$scmdstddev); 
summary(m);
...
m = lm(lifespan$RLS_Del_alpha ~ lifespan$scmdstddev + lifespan$YPE);
summary(m);
...
m = lm(lifespan$scmdstddev ~ lifespan$YPE + lifespan$RLS_Del_alpha);
summary(m);
...
m = lm(lifespan$YPE ~ lifespan$scmdstddev + lifespan$RLS_Del_alpha);
summary(m);

summary(lm(lifespan$YPE ~ lifespan$scmdstddev))
plot(lifespan$YPE ~ lifespan$scmdstddev, ylab="Fitness (YPE)", xlab="Morphological Plasticity")
abline(lm(lifespan$YPE ~ lifespan$scmdstddev), col="red")

save.image("AA2013April.RData");
load("AA2013April.RData");