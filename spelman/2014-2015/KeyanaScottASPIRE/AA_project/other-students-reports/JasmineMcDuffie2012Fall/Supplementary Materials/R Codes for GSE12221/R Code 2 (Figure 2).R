...
#[3] "GSE12221,3821-Jasmine.R"                        
#[4] "GSE12221_log2CV.csv"                            
#[5] "GSE3821_log2CV.csv"                             
#[6] "lifespan.csv"                                   
#[7] "pairs.csv"                                      
#[8] "protein half life.csv"                          
#[9] "Sce.Spa.KaKs.csv"                               
#[10] "sgadata_costanzo2009_stringentCutoff_101120.csv"

list.files(, pattern="GSE12221")
#Answers
# "GSE12221,3821-Jasmine.R"
# "GSE12221_log2CV.csv"  

CV.tb = read.csv("GSE12221_log2CV.csv")  #CV table
...
#-20.4545  -2.6525  -0.1289   3.1711  14.3308 

#Coefficients:
# Estimate Std. Error t value Pr(>|t|)    
#(Intercept)       24.4857     0.4877  50.205   <2e-16 ***
# RLS.tb2$myStddev  -0.6908     7.1077  -0.097    0.923    
#---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 5.117 on 495 degrees of freedom
#Multiple R-squared: 1.908e-05,  Adjusted R-squared: -0.002001 
#F-statistic: 0.009445 on 1 and 495 DF,  p-value: 0.9226 
...
#Residuals:
# Min       1Q   Median       3Q      Max 
#-20.5192  -2.6498  -0.1301   3.2467  14.4031 

#Coefficients:
#  Estimate Std. Error t value Pr(>|t|)    
#(Intercept)     25.7518     4.5138   5.705    2e-08 ***
# RLS.tb2$myMean  -0.3563     1.2279  -0.290    0.772    
#---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 5.117 on 495 degrees of freedom
#Multiple R-squared: 0.00017,  Adjusted R-squared: -0.00185 
#F-statistic: 0.08419 on 1 and 495 DF,  p-value:0.7718
...
#Residuals:
# Min       1Q   Median       3Q      Max 
#-20.4412  -2.6448  -0.1355   3.1596  14.3640 

#Coefficients:
# Estimate Std. Error t value Pr(>|t|)    
#(Intercept)   24.4313     0.4720   51.76   <2e-16 ***
# RLS.tb2$myCV   0.7527    24.7604    0.03    0.976    
#---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 5.118 on 495 degrees of freedom
#Multiple R-squared: 1.867e-06,  Adjusted R-squared: -0.002018 
#F-statistic: 0.0009241 on 1 and 495 DF,  p-value: 0.9758 
...
#Residuals:
# Min       1Q   Median       3Q      Max 
#-20.1202  -2.3201   0.1785   3.1752  13.0004 

#Coefficients:
#Estimate Std. Error t value Pr(>|t|)    
#(Intercept)   24.1357     0.4309  56.014   <2e-16 ***
# RLS.tb2$myCV  -1.1915    22.6039  -0.053    0.958    
#---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 4.672 on 495 degrees of freedom
#Multiple R-squared: 5.614e-06,  Adjusted R-squared: -0.002015 
#F-statistic: 0.002779 on 1 and 495 DF,  p-value: 0.958 
...
#Residuals:
# Min       1Q   Median       3Q      Max 
#-0.90146  0.00624  0.03466  0.04965  0.13010 

#Coefficients:
# Estimate Std. Error t value
#(Intercept)      0.954162   0.004475 213.217
#fitness.tb2$myCV 1.122002   0.237152   4.731
#Pr(>|t|)    
#(Intercept)       < 2e-16 ***
# fitness.tb2$myCV  2.4e-06 ***
#  ---
# Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

#Residual standard error: 0.09908 on 1913 degrees of freedom
#(507 observations deleted due to missingness)
#Multiple R-squared: 0.01157,  Adjusted R-squared: 0.01105 
#F-statistic: 22.38 on 1 and 1913 DF,  p-value: 2.396e-06 
