...
tb = read.csv("g.csv");
tb = read.csv("g.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M34star.08232011.black.pdf", width=5, height=5)
...
pdf("M34star.08232011.black-log.pdf", width=5, height=5)
