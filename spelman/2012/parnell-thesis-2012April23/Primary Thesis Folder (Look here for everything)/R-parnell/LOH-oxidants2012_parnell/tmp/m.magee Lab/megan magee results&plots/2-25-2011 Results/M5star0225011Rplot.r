...
tb = read.csv("Feb25,2001.H2O2effectonLOH.M5star.csv");
tb = read.csv("Feb25,2001.H2O2effectonLOH.M5star.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M5Sstar.022511.black.pdf", width=5, height=5)
