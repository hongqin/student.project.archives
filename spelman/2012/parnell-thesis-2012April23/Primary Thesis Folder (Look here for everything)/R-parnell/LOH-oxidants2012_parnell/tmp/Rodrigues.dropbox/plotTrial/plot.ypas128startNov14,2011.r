...
infile = "YPS128star_H2O2LOH_Nov14,2011.csv"
tb = read.csv(infile);
...
mylabel = 'yps128star,Nov14,11'

pdf("ypsstar.111411.black.pdf", width=5, height=5)
...
pdf("ypasstar.111411.black-log.pdf", width=5, height=5)
