...
tb = read.csv("i.csv");
tb = read.csv("i.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M13star.08242011.black.pdf", width=5, height=5)
...
pdf("M13star.08242011.black-log.pdf", width=5, height=5)
