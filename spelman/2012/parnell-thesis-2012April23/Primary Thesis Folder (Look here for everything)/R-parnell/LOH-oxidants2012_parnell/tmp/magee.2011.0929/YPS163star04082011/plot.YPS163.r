...
tb = read.csv("a.csv");
tb = read.csv("a.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("YPS163star.04082011.black.pdf", width=5, height=5)
...
pdf("YPS163star.04082011.black-log.pdf", width=5, height=5)
...
title("YPS163star.04082011.black")
dev.off()
