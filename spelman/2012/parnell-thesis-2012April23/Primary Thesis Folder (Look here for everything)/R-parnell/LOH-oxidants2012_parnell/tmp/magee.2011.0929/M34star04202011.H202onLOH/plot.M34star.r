...
tb = read.csv("c.csv");
tb = read.csv("c.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M34star.04202011.black.pdf", width=5, height=5)
plot( tbf$s ~ tbf$H2O2, col="blue", axes=F, xlab='', ylab='', ylim=c(-0.5, 1.2), type='p');
...
pdf("M34star.04202011.black-log.pdf", width=5, height=5)
