...
tb = read.csv("b.csv");
tb = read.csv("b.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("YPS163star.04132011.black.pdf", width=5, height=5)
...
title("YPS163 Met15+/- Apr 13, 2011")
dev.off()
...
pdf("YPS163star.04132011.black-log.pdf", width=5, height=5)
...
title("YPS163star.04132011.black")
dev.off()
