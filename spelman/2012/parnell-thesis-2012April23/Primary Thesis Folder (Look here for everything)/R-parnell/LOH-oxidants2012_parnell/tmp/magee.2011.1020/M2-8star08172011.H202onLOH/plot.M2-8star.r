...
tb = read.csv("n.csv");
tb = read.csv("n.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M2-8star.08172011.black.pdf", width=5, height=5)
...
title("M2-8star.08172011.black.pdf")
dev.off()
...
pdf("M2-8star.08172011.black-log.pdf", width=5, height=5)
