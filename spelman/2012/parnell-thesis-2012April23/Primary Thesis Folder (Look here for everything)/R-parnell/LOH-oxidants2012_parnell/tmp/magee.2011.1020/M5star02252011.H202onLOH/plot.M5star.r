...
tb = read.csv("q.csv");
tb = read.csv("q.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M5star.02252011.black.pdf", width=5, height=5)
...
pdf("M5star.02252011.black-log.pdf", width=5, height=5)
