...
tb = read.csv("l.csv");
tb = read.csv("l.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M32star.08102011.black.pdf", width=5, height=5)
...
pdf("M32star.08102011.black-log.pdf", width=5, height=5)
