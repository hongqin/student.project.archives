...
tb = read.csv("t.csv");
tb = read.csv("t.csv", colClasses=c("character",NA, NA, "character", rep("numeric",8 ), NA));
...
pdf("M32Sstar.052511.black.pdf", width=5, height=5)
...
pdf("M32star.05252011.black-log.pdf", width=5, height=5)
